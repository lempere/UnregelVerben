...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>\n      Unregel Verben\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <div class=\"ion-padding\">\n  </div>\n  <div *ngIf=\"word\">\n    <ion-item class=\"header\">\n      <h2>{{word[0]}}</h2>\n      <h5>{{word[3]}}</h5>\n      <ion-icon *ngIf=\"isRight===1\" class=\"icon icon-right\" name=\"checkmark-circle\"></ion-icon>\n      <ion-icon *ngIf=\"isRight===-1\" class=\"icon icon-wrong\" name=\"close-circle\"></ion-icon>\n    </ion-item>\n    <ion-item class=\"body\">\n      <ion-row>\n        <ion-col>\n          <h2>Partizip:</h2>\n        </ion-col>\n      </ion-row>\n      <ion-row>\n        <ion-col>\n          <ion-input type=\"text\" [(ngModel)]=\"typed\" (ionChange)=\"typing()\"></ion-input>\n        </ion-col>\n      </ion-row>\n    </ion-item>\n  </div>\n  <ion-row float-right text-right=\"\">\n      <ion-col>\n        <ion-button (click)=\"next()\" >Nächte</ion-button>\n      </ion-col>\n  </ion-row>\n</ion-content>\n"
...
module.exports = ".header h5 {\n  margin: 0;\n  padding: .6em 0 0 .3em; }\n\n.body ion-input {\n  margin-top: .65em; }\n\n.icon {\n  margin: 0 .3em;\n  font-size: 2.5rem; }\n\n.icon-right {\n  color: green; }\n\n.icon-wrong {\n  color: red; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.readCsvData = function () {
        var _this = this;
        this.http.get('assets/de/unregel_verben.csv', { responseType: 'text' })
            .subscribe(function (data) { return _this.parseData(data); });
    };
    HomePage.prototype.randomN = function () {
        return Math.floor(Math.random() * this.wordList.length);
    };
    HomePage.prototype.parseData = function (data) {
        var _this = this;
        var csv = data || '';
        var lines = csv.split('\n');
    ...
    HomePage.prototype.typing = function () {
        var check = this.word[2].split(' ')[0];
